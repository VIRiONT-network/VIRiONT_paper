...
file_output_PC<-argv[3]
file_output_BCP<-argv[4]
file_output_DS<-argv[5]
file_output_RT<-argv[6]
file_output_DPS1<-argv[7]
file_output_DPS2<-argv[8]
file_output_DHBx<-argv[9]
file_output_C<-argv[10]
...
#read mutation table
table_mut<-read.csv2(tablemut_input)
